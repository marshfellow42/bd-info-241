...
E também baixar uma biblioteca para o sistema de cores em Python:

```bash
pip install colorama
```

O código Python para rodar esse CRUD é esse:
...
def create_data_on_table(tabela):
    match(tabela):
        ...
        case "Matricula":
            ...
            mycursor.execute("INSERT INTO Matricula (nome_aluno, nome_professor, disciplina, nota_N1, nota_N2, faltas, Aprovado_SN) VALUES (%s, %s, %s, %s, %s, %s, %s);", (nome_aluno, nome_professor, disciplina, nota_N1, nota_N2, faltas, aprovado_sn))
            mydb.commit()
...
def read_data_on_table(tabela):
    ...
    match(tabela):
        ...
        case "Matricula":
            for item in meuresultado:
                id, id_aluno, id_professor, disciplina, nota_N1, nota_N2, faltas, aprovado_sn = item
...
def update_data_on_table(tabela):
    id = int(input("Qual o id do usuário que você deseja atualizar: "))
    match(tabela):
        case "TB_ALUNOS":
            nome = input("Coloque o nome do aluno: ")
        ...
        case "TB_DISCIPLINA":
            ...
            mydb.commit()
        case "Matricula":
            nome_aluno = input("Coloque o nome do aluno: ")
            nome_professor = input("Coloque o nome do professor: ")
            disciplina = input("Coloque o nome da disciplina: ")
            nota_N1 = float(input("Coloque a nota da N1: "))
            nota_N2 = float(input("Coloque a nota da N2: "))
            faltas = int(input("Coloque o número de faltas: "))
            ...
            mycursor.execute(f"UPDATE Matricula SET nome_aluno = %s, nome_professor = %s, disciplina = %s, nota_N1 = %s, nota_N2 = %s, faltas = %s, Aprovado_SN = %s WHERE id = %s;", (nome_aluno, nome_professor, disciplina, nota_N1, nota_N2, faltas, aprovado_sn, id))
            mydb.commit()

# Delete
def delete_data_on_table(tabela):
    id = int(input("Qual o id do usuário que você deseja deletar: "))
