...
def create_data_on_table(tabela):
    match(tabela):
        ...
        case "Matricula":
            ...
            mycursor.execute("INSERT INTO Matricula (id_aluno, id_professor, id_disciplina, nota_N1, nota_N2, faltas, Aprovado_SN) VALUES (%s, %s, %s, %s, %s, %s, %s);", (nome_aluno, nome_professor, disciplina, nota_N1, nota_N2, faltas, aprovado_sn))
            mydb.commit()
...
def update_data_on_table(tabela):
    ...
    match(tabela):
        ...
        case "Matricula":
            ...
            mycursor.execute(f"UPDATE Matricula SET id_aluno = %s, id_professor = %s, id_disciplina = %s, nota_N1 = %s, nota_N2 = %s, faltas = %s, Aprovado_SN = %s WHERE id = %s;", (id_aluno, id_professor, id_disciplina, nota_N1, nota_N2, faltas, aprovado_sn, id))
            mydb.commit()
...
""")
        ...
        case 2:
            ...
            mycursor.execute("INSERT INTO Matricula (id_aluno, id_professor, id_disciplina, nota_N1, nota_N2, faltas, Aprovado_SN) VALUES (%s, %s, %s, %s, %s, %s, %s);", (id_aluno, id_professor, id_disciplina, nota_N1, nota_N2, faltas, aprovado_sn))
            mydb.commit()
